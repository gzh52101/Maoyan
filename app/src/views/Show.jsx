...
function Show() {
    ...
    return (
        <div className="show">
            ...
            <ul>
                <div>
                    <li><img src="./img/yanchang.png" alt="" /></li>
                    <span>演唱会</span>
                </div>
                <div>
                    <li><img src="./img/xiju.png" alt="" /></li>
                    <span>话剧歌剧</span>
                </div>
                <div>
                    <li><img src="./img/xiuxian.png" alt="" /></li>
                    <span>休闲展览</span>
                    <p>侏罗纪展</p>
                </div>
                <div>
                    <li><img src="./img/xiangsheng.png" alt="" /></li>
                    <span>相声戏曲</span>
                </div>
                <div>
                    <li><img src="./img/qinzi.png" alt="" /></li>
